          ...
          <section className="flex flex-col gap-5 rounded border border-line bg-panel p-6">
            ...
            <div className="rounded border border-line bg-panel-2 p-6 text-center">
              ...
              <div
                className={`font-mono text-4xl font-bold tracking-tight ${
                  isZeroSpan ? "text-crimson" : "text-amber drop-shadow-[0_0_12px_rgba(255,176,0,0.35)]"
                }`}
              >
                {isZeroSpan ? "ERROR" : pv.toFixed(3)}
              </div>
              <div className="font-mono text-sm text-text-dim mt-1">
                {isZeroSpan
                  ? "Zero Span (URV cannot equal LRV)"
                  : `${unit} (${pctSpan}% OF SPAN)`}
              </div>
            </div>
            ...
            <div className="my-1">
              <div className="flex justify-between font-mono text-xs text-text-faint mb-1">
                <span>4.0 mA (0%)</span>
                <span className="text-text">{pctSpan}%</span>
                <span>20.0 mA (100%)</span>
              </div>
              <div className="h-3 rounded-full border border-line bg-panel-2 overflow-hidden">
                <div
            ...
            <div className="rounded border border-line bg-panel-2 p-3 font-mono text-xs text-text-dim">
